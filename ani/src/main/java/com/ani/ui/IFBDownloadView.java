...
public class IFBDownloadView extends AbstractView {
	...
	protected void renderMergedOutputModel(
		...
		String userName = (String) params.get("userFileName");
		String saveName = (String) params.get("savedFileName");
		//다운로드 처리
		...
		//3. 파일을 응답스트림에 기록
		String file2 = 
			request.getSession().getServletContext().getRealPath("/WEB-INF/upload/"+saveName);
